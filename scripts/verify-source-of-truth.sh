...
require_grep "defaultHUDOriginIsShiftedRightOfCenter" "Tests/SpotlightTests/SpotlightWindowControllerTests.swift"
require_grep "defaultHUDOriginIsSlightlyBelowMidline" "Tests/SpotlightTests/SpotlightWindowControllerTests.swift"
require_grep "defaultRightwardOffsetRatio: CGFloat = 0.30" "Sources/Spotlight/SpotlightWindow.swift"
require_grep "center toward the right edge" "Tests/SpotlightTests/SpotlightWindowControllerTests.swift"
require_grep "right of center" "AGENTS.md"
...
require_grep "editorFontName = \"IBMPlexMono\"" "Sources/Spotlight/SpotNoteFont.swift"
...
require_grep "## To Do" "Sources/Spotlight/VaultInboxDocument.swift"
require_grep "gD jumps to the To Do section" "Tests/SpotlightTests/VimEngineTests.swift"
...
if [[ "$CHECK_INSTALLED" == "1" ]]; then
  ...
  /usr/bin/grep -F -- "## To Do" <<<"$STRINGS" >/dev/null \
    || fail "installed binary missing To Do heading contract string"
